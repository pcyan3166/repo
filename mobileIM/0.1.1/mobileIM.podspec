#
# Be sure to run `pod lib lint mobileIM.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'mobileIM'
  s.version          = '0.1.1'
  s.summary          = 'A short description of mobileIM.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'mobileIM/Classes/**/*'
  
  # s.resource_bundles = {
  #   'mobileIM' => ['mobileIM/Assets/*.png']
  # }
